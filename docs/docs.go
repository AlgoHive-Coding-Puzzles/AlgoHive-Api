...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/catalogs/{catalogID}/themes/{themeID}/puzzles/{puzzleID}/inputs/{inputID}/first/{solution}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
        ...
        "/catalogs/{catalogID}/themes/{themeID}/puzzles/{puzzleID}/inputs/{inputID}/second/{solution}": {
            "get": {
                "security": [
                    {
                        "Bearer": []
